		...
		<tbody>
				<tr>
					<td>
						...
						<input type="hidden" name="item_name" value="Art-Empire">
						<input type="hidden" name="item_description" value="Your All in one Art-Empire">
						<input type="hidden" name="item_number" value="3456">
						<input type="hidden" name="amount" value="<?php echo $_SESSION['tp']="$totalprice"; ?>">
						<input type="hidden" name="address" value="<?php echo $row['billingAddress'];?>">
						<input type="hidden" name="currency" value="INR">	
						<input type="hidden" name="cust_name" value="<?php echo $row['name'];?>">								
						<input type="hidden" name="email" value="<?php echo $row['email'];?>">	
						<input type="hidden" name="contact" value="<?php echo $row['contactno'];?>">								
						<input type="submit" name="ordersubmit" class="btn btn-primary" value="Buy Now">					
					</form>	 -->
						</div>
					</td>
				</tr>
