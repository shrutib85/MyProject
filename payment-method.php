...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="Cash on Delivery" checked="checked"> Cash on Delivery
	     <input type="radio" name="paymethod" value="pay online"> Pay Online <br /><br />
    ...
    <script>
        jQuery(document).ready(function($) 
        {
            ...
            var radio = $('input[name="paymethod"]');
            var choice = '';
            ...
            radio.change(function(e) 
            {
                ...
                if (choice === 'orders') 
                {
                    form.attr('action', 'order-history.php?paymenthod=Cash on Delivery');
                } 
                else 
                {
                    form.attr('action', 'pay.php?paymenthod=pay online');
                }
            });
        });
    </script>
